...
class interface:
    ...
    def initSprites(self):
        self.sprites = {AIR:pg.Surface((50,50)),
                        ...
                        UPRIGHT:pg.image.load(PATH+'downleft.png').convert_alpha(),
                        ...
                        DOWNLEFTRIGHT:pg.image.load(PATH+'downleftright.png').convert_alpha(),
                        DOWNUPLEFT:pg.image.load(PATH+'downupleft.png').convert_alpha(),
                        DOWNUPRIGHT:pg.image.load(PATH+'downupright.png').convert_alpha(),
                        ...
                        LEFTDOWN:pg.image.load(PATH+'rightupdown.png').convert_alpha(),
