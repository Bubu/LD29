...
class root:
    ...
    def check_down(self):
        ...
        if self.game.grid[self.pos[0]+1][self.pos[1]] in ACCESS:
            self.pos = (self.pos[0]+1,self.pos[1])
            self.dir = DOWN
            return DOWN
        elif self.pos[1] < RES_X//100:
            if self.pos[1] > 0 and self.game.grid[self.pos[0]][self.pos[1]-1] in ACCESS:
                self.pos = (self.pos[0],self.pos[1]-1)
                self.dir = LEFT
                return LEFT
            elif self.game.grid[self.pos[0]][self.pos[1]+1] in ACCESS:
                self.pos = (self.pos[0],self.pos[1]+1)
                self.dir = RIGHT
                return RIGHT
            else:
            ...
            if self.pos[1] < RES_X//50 and self.game.grid[self.pos[0]][self.pos[1]+1] in ACCESS:
                self.pos = (self.pos[0],self.pos[1]+1)
                self.dir = RIGHT
                return RIGHT
            elif self.game.grid[self.pos[0]][self.pos[1]-1] in ACCESS:
    ...
    def check_right(self):
        ...
        if self.pos[1] < RES_X//100:
            if self.game.grid[self.pos[0]][self.pos[1]+1] in ACCESS:
                self.pos = (self.pos[0],self.pos[1]+1)
                self.dir = RIGHT
                return RIGHT
            elif self.game.grid[self.pos[0]+1][self.pos[1]] in ACCESS:
                self.pos = (self.pos[0]+1,self.pos[1])
                self.dir = DOWN
                return DOWN
            elif self.game.grid[self.pos[0]-1][self.pos[1]] in ACCESS:
